...
done def creerPartie(joueur1,joueur2) : 
...
done def setJoueurCourant(joueur,partie) :
...
done def changeJoueurCourant(partie) :
    # Pre-condition : partie est de type Partie
    # Post-condition : Aucune
